...
alert_sound = "beep.wav"  # Replace with the path to your sound file
try:
...
# Timers for tracking drowsiness and phone detection
drowsy_start_time = None
phone_start_time = None
alert_duration = 2  # Time in seconds before triggering the alert
...
while True:
    ...
    if label == "drowsy":
        ...
        elif time.time() - drowsy_start_time >= alert_duration:
    ...
    if phone_detected:
        ...
        elif time.time() - phone_start_time >= alert_duration:
            if not pygame.mixer.music.get_busy():
                pygame.mixer.music.play()
    else:
        phone_start_time = None
